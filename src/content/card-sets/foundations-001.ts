...
export const FOUNDATIONS_001_CARDS = {
  ...
  living_flame: u('living_flame', '살아 움직이는 불꽃', 1, 2, 1, ['fire'], '없음.',
    {
      flavorText: '고대 사람들은 집마다 하나씩 키웠습니다.',
    }),
  living_smoke: u(
  ...
  burning_procession: s(
    ...
    {
      flavorText: '땅의 군세가 하나둘 불꽃에 합류했다.',
    },
  ),
  ash_pirate_ship: u(
  ...
  floating_mountains: u('floating_mountains', '떠다니는 산맥', 6, 5, 6, ['earth'], '질풍.', {
      keywords: ['windfury'],
      flavorText: '추락할 걱정 속에서 모두는 산을 떠나지 못했다.',
    }),
  grave_digging: s(
  ...
  holy_mirror_wall: s(
    ...
    {
      flavorText: '숭고한 힘. 그 힘은 거울 속에 있다.',
    },
  ),
  battle_campfire: s(
