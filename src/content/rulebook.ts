        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              { term: '공명', description: '자신의 마나 영역에 지정 속성 카드가 한 장이라도 있으면 적용됩니다. 그 마나가 준비·소진 상태인지는 관계없습니다.' },
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              '준비 상태인 수호 몬스터가 공격 가능하다면 그중 하나를 먼저 공격해야 합니다. 수호 몬스터가 여러 장이면 공격자가 원하는 하나를 고릅니다.',
        ...
        blocks: [
          {
            ...
            items: [
              ...
              '카드를 뽑아야 할 때 덱이 비어 있으면 즉시 패배합니다. 묘지는 덱으로 다시 섞지 않습니다.',
        ...
        blocks: [
          {
            ...
            items: [
              ...
              { term: '수호', description: '이 몬스터가 준비 상태이고 공격 가능한 대상이라면, 상대는 공격 가능한 수호 몬스터 중 하나를 먼저 공격해야 합니다. 수호 몬스터가 여러 장이면 그중 하나를 선택합니다.' },
              { term: '암살', description: '이 능력을 가진 몬스터가 다른 몬스터와 전투하면, 전투한 상대 몬스터를 전투 뒤 묘지로 보냅니다.' },
