...
const BALANCE = {
  volcano_mouse: ['화산쥐', 'unit', 1, 1, 1, ['fire']],
  living_flame: ['살아 움직이는 불꽃', 'unit', 1, 2, 1, ['fire']],
  living_smoke: ['살아 움직이는 연기', 'unit', 2, 2, 1, ['fire']],
  ...
  ripple_spirit: ['잔물결 정령', 'unit', 2, 2, 3, ['water']],
  ebb: ['썰물', 'spell', 3, null, null, ['water']],
  surging_wave: ['몰아치는 파도', 'unit', 3, 2, 3, ['water']],
  ash_clearing_rain: ['잿더미를 치우는 비', 'spell', 4, null, null, ['water']],
  high_tide: ['밀물', 'spell', 4, null, null, ['water']],
  reverse_current: ['역류', 'spell', 4, null, null, ['water']],
  tsunami: ['쓰나미', 'spell', 3, null, null, ['water', 'earth']],
  tree_fairy: ['나무에 사는 요정', 'unit', 1, 0, 1, ['earth']],
  seeding_fairy: ['씨 뿌리는 요정', 'unit', 2, 1, 1, ['earth']],
  ...
  carrion_crow: ['시체를 먹는 까마귀', 'unit', 1, 1, 1, ['dark']],
  corpse_cat: ['시체에 숨은 고양이', 'unit', 1, 1, 2, ['dark']],
  nameless_shadow: ['이름 없는 그림자', 'unit', 2, 2, 1, ['dark']],
  ...
  pegasus_rider: ['페가수스 기마병', 'unit', 2, 1, 1, ['light']],
  temple_prospect: ['신전의 유망주', 'unit', 2, 1, 1, ['light']],
  cathedral_guard: ['성당 경비병', 'unit', 2, 1, 3, ['light']],
  prophet: ['예언자', 'unit', 3, 2, 3, ['light']],
  apostle_pigeon: ['사도의 비둘기', 'unit', 3, 1, 3, ['light']],
  devotion: ['헌신', 'spell', 5, null, null, ['light']],
...
describe('카드군 1 개정 원고', () => {
  ...
  test('규칙 변화가 큰 카드의 능력 문구를 보존한다', () => {
    expect(CARDS.burning_procession.rulesText).toContain('덱 맨 위 카드 4장')
    expect(CARDS.burning_procession.rulesText).toContain('최대 2장')
    expect(CARDS.surging_wave.rulesText).toContain('덱 맨 위 카드 2장')
