...
const BALANCE = {
  ...
  living_smoke: ['살아 움직이는 연기', 'unit', 2, 0, 2, ['fire']],
  ...
  ebb: ['썰물', 'spell', 2, null, null, ['water']],
  ...
  floating_mountains: ['떠다니는 산맥', 'unit', 5, 5, 5, ['earth']],
  ...
  temple_prospect: ['신전의 유망주', 'unit', 1, 1, 2, ['light']],
